# beamerthemetechnikum-fonts

Additional [Noto](https://fonts.google.com/noto) font families for extended script support in the [beamerthemetechnikum](https://github.com/sabicalija/beamerthemetechnikum) theme.

The base theme ships with Noto Sans, Serif, Sans Mono, and Sans Math (Latin/Cyrillic/Greek). This repository provides optional fonts for additional scripts.
...
| `cjk/tc/` | Traditional Chinese | [notofonts/noto-cjk](https://github.com/notofonts/noto-cjk) |

## License

All fonts are licensed under the [SIL Open Font License, Version 1.1](OFL.txt).
